...
def Label_Aug(L, scores, X, y, instance_index_ranges, detector_index_ranges, max_iteration=20, n_jobs=1):  # add param here that is none on defult: takes in human labels
    L_prev = L
    scores_prev = scores
