...
def Label_Clean(X, y, L, det_scores, max_iteration=20, initial_set='avg', ratio_to_remove=0.05, separate_inline_outlier=False, inlier=0.0001, outlier=0.9999, early_stop=True, slidingWindow=0, n_jobs=1):
